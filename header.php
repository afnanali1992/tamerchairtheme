		...
		<header>
			<div class="theme-main-menu theme-menu-two main-p-color sticky-menu fixed"">
				...
				<div class="d-flex  logo-header row align-items-center justify-content-between">
					...
					<div class="logo lg-4 title-chair-header d-none d-sm-block" style="text-align: center; font-size: 16px; font-weight: bold;  margin-right: -45px;"> <?php if( pll_current_language() == 'en') { ?>
